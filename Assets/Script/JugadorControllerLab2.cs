...
public class JugadorControllerLab2 : MonoBehaviour
{
    ...
    void setTextoContador()
    {
        ...
        if (contador >= 3) // Asumiendo que 3 es el número total de coleccionables necesarios para ganar
        {
            GanarJuego();
        }
    }
    ...
    void PerderJuego()
    {
        ...
        Invoke("ReloadCurrentLevelOrMainMenu", 5f); // Llamar a ReloadCurrentLevelOrMainMenu después de 5 segundos
    }
    ...
    void ReloadCurrentLevelOrMainMenu()
    {
        ...
        {
            BackToMainMenu(); // Volver al menú principal si es la escena "jugador"
        }
        else
        {
